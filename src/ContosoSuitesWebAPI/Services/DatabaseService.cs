...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings for a hotel and a specified start date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")]int hotelId, [Description("The start date of the booking for the hotel")]DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Retrieves bookings that do not have any associated hotel room entries.")]
    ...
    [KernelFunction]
    [Description("Retrieves bookings that have more than one associated hotel room entry.")]
